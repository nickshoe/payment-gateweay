...
/**
 * Service Implementation for managing {@link com.mycompany.myapp.domain.Payment}.
 */
@Service
@Transactional
public class PaymentServiceImpl implements PaymentService {
    ...
    @Override
    public Optional<PaymentDTO> findOneByExternalId(String externalId) {
        LOG.debug("Request to get Payment by external id: {}", externalId);
        return paymentRepository.findByExternalId(externalId).map(paymentMapper::toDto);
    }
